...
@Component({
  selector: 'app-add-conditionnementvent',
  templateUrl: './add-conditionnementvent.component.html',
  styleUrls: ['./add-conditionnementvent.component.css'],
})
export class AddConditionnementventComponent {
