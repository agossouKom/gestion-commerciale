...
@Component({
  selector: 'app-liste-mode-reglement',
  templateUrl: './liste-mode-reglement.component.html',
  styleUrls: ['./liste-mode-reglement.component.css'],
})
export class ListeModeReglementComponent {
  ...
  update(id: number) {
    this.router.navigate(['/modeReglement/edit/', id]);
  }
}
