...
@Component({
  selector: 'app-liste-type-code-bar',
  templateUrl: './liste-type-code-bar.component.html',
  styleUrls: ['./liste-type-code-bar.component.css']
})
export class ListeTypeCodeBarComponent {
...
//  routerLink="/pays/edit/{{ dataList.idPays }}"
  update(id: number) {
    this.router.navigate(['/typeCodeBar/edit/', id]);
  }
}
