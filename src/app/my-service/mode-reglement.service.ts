...
import { TokenStorageService } from '../shared/token-storage.service';
  ...
  export class ModeReglementService {
    ...
    getAll() {
      return this.http.get<ModeReglement[]>(allData);
    }

    getById(id: any) {
      //console.log(getPerId);
     // console.log(id);
      return this.http.get<ModeReglement>(`${getPerId}/${id}`);
    }

    getActif() {
      return this.http.get<ModeReglement[]>(actif);
    }

    create(params: ModeReglement) {
    ...
    update(id: number, value: ModeReglement): Observable<Object> {
