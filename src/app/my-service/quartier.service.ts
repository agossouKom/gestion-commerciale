...
import { Quartier } from '../my-modele/quartier';
...
const entity = '/quartiers-villages';
...
export class QuartierService {
  ...
  getAll() {
    return this.http.get<Quartier[]>(allData);
  }

  getById(id: any) {
    //console.log(getPerId);
   // console.log(id);
    return this.http.get<Quartier>(`${getPerId}/${id}`);
  }

  getActif() {
    return this.http.get<Quartier[]>(actif);
  }

  create(params: Quartier) {
  ...
  update(id: number, value: Quartier): Observable<Object> {
