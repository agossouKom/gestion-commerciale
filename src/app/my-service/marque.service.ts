...
import { Marque } from '../my-modele/marque';
import { TokenStorageService } from '../shared/token-storage.service';
  ...
  export class MarqueService {
    ...
    getAll() {
      return this.http.get<Marque[]>(allData);
    }

    getById(id: any) {
      //console.log(getPerId);
     // console.log(id);
      return this.http.get<Marque>(`${getPerId}/${id}`);
    }

    getActif() {
      return this.http.get<Marque[]>(actif);
    }

    create(params: Marque) {
    ...
    update(id: number, value: Marque): Observable<Object> {
