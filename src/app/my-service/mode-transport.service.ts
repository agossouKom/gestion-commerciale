...
export class ModeTransportService {
  ...
  getAll() {
    return this.http.get<ModeTransport[]>(allData);
  }

  getById(id: any) {
    //console.log(getPerId);
   // console.log(id);
    return this.http.get<ModeTransport>(`${getPerId}/${id}`);
  }

  getActif() {
    return this.http.get<ModeTransport[]>(actif);
  }

  create(params: ModeTransport) {
  ...
  update(id: number, value: ModeTransport): Observable<Object> {
