...
import { TypeCodeBar } from '../my-modele/type-code-bar';
import { TokenStorageService } from '../shared/token-storage.service';
  ...
  export class TypeCodeBarService {
    ...
    getAll() {
      return this.http.get<TypeCodeBar[]>(allData);
    }

    getById(id: any) {
      //console.log(getPerId);
     // console.log(id);
      return this.http.get<TypeCodeBar>(`${getPerId}/${id}`);
    }

    getActif() {
      return this.http.get<TypeCodeBar[]>(actif);
    }

    create(params: TypeCodeBar) {
    ...
    update(id: number, value: TypeCodeBar): Observable<Object> {
