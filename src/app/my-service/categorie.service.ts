...
import { Categosie } from '../my-modele/categosie';
import { TokenStorageService } from '../shared/token-storage.service';
import { RayonCategorie } from '../my-modele/rayon-categorie';
...
const actifRayon =urlBase+apiPrefix + '/rayonCategorie/actifs';
...
export class CategorieService {
  ...
  getAll() {
    return this.http.get<Categosie[]>(allData);
  }

  getById(id: any) {
    //console.log(getPerId);
   // console.log(id);
    return this.http.get<Categosie>(`${getPerId}/${id}`);
  }

  getActif() {
    return this.http.get<Categosie[]>(actif);
  }
  getActifRayon() {
    return this.http.get<RayonCategorie[]>(actifRayon);
  }
  create(params: Categosie) {
  ...
  update(id: number, value: Categosie): Observable<Object> {
